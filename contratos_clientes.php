                ...
                <tbody>
                    <?php if (!empty($contratos)):
                        foreach ($contratos as $contrato):
                            $status_class = ($contrato['status'] === 'Finalizado') ? 'bg-warning' : 'bg-success';

                            $adenda_fechafin_class = '';
                            if (!empty($contrato['ultima_fechafin'])) {
                                $adenda_fechafin_class = (new DateTime($contrato['ultima_fechafin']) < new DateTime()) ? 'bg-warning' : 'bg-success';
                            }
                    ?>
                            <tr>
                                ...
                                <td>
                                    <?php if (isset($contrato['activo']) && $contrato['activo'] == 1): ?>
                                        <span class="badge <?php echo $status_class; ?>">Activo</span>
                                    <?php else: ?>
                                        <span class="badge bg-danger">Inactivo</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo htmlspecialchars($contrato['ultima_numeroadenda'] ?? 'N/A'); ?></td>
                                <td>
                                    <?php if (!empty($contrato['ultima_fechafin'])): ?>
                                        <span class="badge <?php echo $adenda_fechafin_class; ?>">
                                            <?php echo htmlspecialchars(date("d/m/Y", strtotime($contrato['ultima_fechafin']))); ?>
                                        </span>
                                    <?php else: ?>
                                        N/A
                                    <?php endif; ?>
                    ...
                    ?>
                        <tr>
                            <td colspan="12" class="text-center">No hay contratos registrados o que coincidan con el filtro.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
